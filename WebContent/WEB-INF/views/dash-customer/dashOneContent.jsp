...
<div>
	<c:if test="${re_step == 0}">
		<span>
			...
			"window.location='dashOneForm.do?ref=${dto.ref}&re_step=${dto.re_step}&num=${dto.num}&title=${dto.title}&snum=${dto.snum}&pageNum=${pageNum}'">
		</span>
	</c:if>
	<span><button onclick="return bossDel();">글삭제</button></span>
	<span><input type="button" value="글수정" onclick="window.location='dashOneModify.do?snum=${dto.snum}&num=${dto.num}&pageNum=${pageNum}'"></span>
