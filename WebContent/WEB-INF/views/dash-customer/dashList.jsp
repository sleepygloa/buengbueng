...
<div>
		...
		<span><a href="dashBoardContent.do?num=${list.num}&pageNum=${pageNum}&pageNum2=${pageNum2}&pageNum3=${pageNum3}&pageNum4=${pageNum4}&pageNum5=${pageNum5}&number=${number}"
...
<div style="width:50%;height:auto;float:left;">
<div>자주 묻는 질문</div>
	<div><a href="dashBoardWriteForm.do?snum=${snum2}&pageNum=${pageNum}&pageNum2=${pageNum2}&pageNum3=${pageNum3}&pageNum4=${pageNum4}&pageNum5=${pageNum5}"
	onclick="window.open(this.href,'_blank','width=700, height=400, left=30, top=30, scrollbars=no,titlebar=no,status=no,resizable=no,fullscreen=no'); return false;"
	>글쓰기</a>
	</div>
	<span>번호</span>
...
<div>
		...
		<span><a href="dashBoardContent.do?num=${list2.num}&pageNum=${pageNum}&pageNum2=${pageNum2}&pageNum3=${pageNum3}&pageNum4=${pageNum4}&pageNum5=${pageNum5}&number=${number2}"
		onclick="window.open(this.href,'_blank','width=700, height=400, left=30, top=30, scrollbars=no,titlebar=no,status=no,resizable=no,fullscreen=no'); return false;"
		>${list2.title}</a></span>
...
<div>
		...
		<span><a href="dashBoardContent.do?num=${list3.num}&pageNum=${pageNum}&pageNum2=${pageNum2}&pageNum3=${pageNum3}&pageNum4=${pageNum4}&pageNum5=${pageNum5}&number=${number3}"
		onclick="window.open(this.href,'_blank','width=700, height=400, left=30, top=30, scrollbars=no,titlebar=no,status=no,resizable=no,fullscreen=no'); return false;"
		>${list3.title}</a></span>
...
<div>
		...
		<span><a href="dashBoardContent.do?num=${list4.num}&number=${number4}&pageNum=${pageNum}&pageNum2=${pageNum2}&pageNum3=${pageNum3}&pageNum4=${pageNum4}&pageNum5=${pageNum5}"
		onclick="window.open(this.href,'_blank','width=700, height=400, left=30, top=30, scrollbars=no,titlebar=no,status=no,resizable=no,fullscreen=no'); return false;"
		>${list4.title}</a></span>
...
<div>
	...
	<c:if test="${startPage5 > 10}">
        <a href="dashBoardSearch.do?column=${column}&keyword=${keyword}&pageNum=${pageNum}&pageNum3=${pageNum3}&pageNum4=${pageNum4}&pageNum5=${pageNum5}&pageNum2=${ startPage5 - 10 }">[이전]</a>
	</c:if>
	<c:forEach var="i2" begin="${startPage5}" end="${endPage5}">
		<a href="dashBoardSearch.do?column=${column}&keyword=${keyword}&pageNum=${pageNum}&pageNum3=${pageNum3}&pageNum4=${pageNum4}&pageNum5=${pageNum5}&pageNum2=${i5}">[${i5}]</a>
	</c:forEach>
	<c:if test="${endPage5 < pageCount5}">
    	<a href="dashBoardSearch.do?column=${column}&keyword=${keyword}&pageNum=${pageNum}&pageNum3=${pageNum3}&pageNum4=${pageNum4}&pageNum5=${pageNum5}&pageNum2=${ startPage5 + 10 }">[다음]</a>
	</c:if>
</c:if>
</div>
