...
<c:if test="${favoritePCRoom == null}">
	<input type="button" class="modiBtn2" value="즐겨찾는 PC방 추가" onclick="addFavoritePCRoom();"/>
</c:if>
<c:if test="${favoritePCRoom != null}">
	<input type="button" class="modiBtn2" value="즐겨찾는 PC방 삭제" onclick="deleteFavoritePCRoom();"/>
</c:if>
<br/>
규모 : ${franchiseeInfo.b_size}<br/>
좌석 개수 : ${franchiseeInfo.b_pccount}&emsp;<input type="button" class="modiBtn2" value="정보 보기" onclick="pcInfo('${franchiseeInfo.b_name}','${franchiseeInfo.b_id}');"/></br>
