...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<form action="employeeCalenderEventInfoUpdatePro.do" method="post" onsubmit=" opener.parent.location.reload();self.close();">
		<h2>일정 세부정보</h2>
 		<br />
		...
		<input class="col-xs-6-12" type="button" value="삭제">
 	</form>		
