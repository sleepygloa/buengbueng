...
/**/
.fc-view-container{width:96%; margin:0 auto;}
.fc-day-header{height:25px;}
.fc-toolbar{width: 96%; margin: 0 auto; margin-bottom: 10px;}
thead{line-height: 2;}
.fc-left button{/* color:red; */ background: none; border:1px #e7ecf1 solid; font-size: 14px;}
.fc-right button{/* color:red; */ background: none; border:1px #e7ecf1 solid; font-size: 14px; box-shadow: 0px 0px 0px #fff;}
/**/
