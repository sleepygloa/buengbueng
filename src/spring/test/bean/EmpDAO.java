...
public class EmpDAO {
	...
	public List<EmpDTO> adempSel(EmpDTO dto) { // admin ��ü��ȸ
	...
	public List<EmpDTO> adempname(EmpDTO dto) { // admin �̸���ȸ
		List<EmpDTO> list = null;
		try {
	...
	public List<EmpDTO> adempdep(EmpDTO dto) { // admin �μ���ȸ
		List<EmpDTO> list = null;
		try {
	...
	public List<EmpDTO> adempsabun(EmpDTO dto) { // admin �����ȸ
		List<EmpDTO> list = null;
		try {
