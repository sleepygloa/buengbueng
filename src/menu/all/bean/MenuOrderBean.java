...
public class MenuOrderBean {
	...
	public String menuOrderComplete(HttpServletRequest request, double barcode, int num, String name, String l_key){
		int check=0;
		try{
			System.out.println(name+l_key+barcode);
			HashMap map=new HashMap();
